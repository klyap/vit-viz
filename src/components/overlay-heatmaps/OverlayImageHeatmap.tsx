...
import { OverlayImageHeatmapRenderer } from "./OverlayImageHeatmapRenderer";
...
export const OverlayImageHeatmap = ({ width, height, data, hoveredCell, setHoveredCell }: HeatmapProps) => {
